...
#! @Returns a morphism ⥉ $\mathrm[Hom]( a_[\vee] \otimes b, \mathrm[\underline[coHom]](b,a)$.
#! @Arguments a,b
...
#! two objects $a,b$,
#! && an object $r == \mathrm[\underline[coHom]](b,a)$.
#! The output is the inverse of $\mathrm[MorphismFromInternalCoHomToTensorProductWithGivenObjects]$, namely
#! $\mathrm[MorphismFromTensorProductToInternalCoHomWithGivenObjects]_[a,b]: a_[\vee] \otimes b \rightarrow \mathrm[\underline[coHom]](b,a)$.
#! @Returns a morphism ⥉ $\mathrm[Hom]( a_[\vee] \otimes b, \mathrm[\underline[coHom]](b,a)$.
#! @Arguments s,a,b,r
...
#! @Returns a morphism ⥉ $\mathrm[Hom]( \mathrm[\underline[coHom]](a,b) \otimes \mathrm[\underline[coHom]](a',b'), \mathrm[\underline[coHom]](a \otimes a', b \otimes b' )$.
#! @Arguments list
...
#! && two objects $s == \mathrm[\underline[coHom]](a,b) \otimes \mathrm[\underline[coHom]](a',b')$ && $r == \mathrm[\underline[coHom]](a \otimes a', b \otimes b')$.
#! The output is the natural morphism
#! $\mathrm[InternalCoHomTensorProductCompatibilityMorphismInverseWithGivenObjects]_[a,a',b,b']: \mathrm[\underline[coHom]](a,b) \otimes \mathrm[\underline[coHom]](a',b') \rightarrow \mathrm[\underline[coHom]](a \otimes a', b \otimes b')$.
#! @Returns a morphism ⥉ $\mathrm[Hom]( \mathrm[\underline[coHom]](a,b) \otimes \mathrm[\underline[coHom]](a',b'), \mathrm[\underline[coHom]](a \otimes a', b \otimes b' )$.
#! @Arguments s, list, r
...
#! @Returns a morphism ⥉ $\mathrm[Hom](a \otimes a_[\vee], 1)$.
#! @Arguments a
...
#! @Returns a morphism ⥉ $\mathrm[Hom](1,1)$.
#! @Arguments alpha
...
#! @Returns a morphism ⥉ $\mathrm[Hom](a, (a_[\vee])_[\vee])$.
#! @Arguments a
