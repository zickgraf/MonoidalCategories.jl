...
#! @Returns a morphism ⥉ $\mathrm[Hom]( \mathrm[\underline[Hom]](a,b), a^[\vee] \otimes b )$.
#! @Arguments a,b
...
#! @Returns a morphism ⥉ $\mathrm[Hom]( \mathrm[\underline[Hom]](a \otimes b,a' \otimes b'), \mathrm[\underline[Hom]](a,a') \otimes \mathrm[\underline[Hom]](b,b') )$.
#! @Arguments list
...
#! && two objects $s == \mathrm[\underline[Hom]](a \otimes b,a' \otimes b')$ && $r == \mathrm[\underline[Hom]](a,a') \otimes \mathrm[\underline[Hom]](b,b')$.
#! The output is the natural morphism
#! $\mathrm[TensorProductInternalHomCompatibilityMorphismInverseWithGivenObjects]_[a,a',b,b']: \mathrm[\underline[Hom]](a \otimes b,a' \otimes b') \rightarrow \mathrm[\underline[Hom]](a,a') \otimes \mathrm[\underline[Hom]](b,b')$.
#! @Returns a morphism ⥉ $\mathrm[Hom]( \mathrm[\underline[Hom]](a \otimes b,a' \otimes b'), \mathrm[\underline[Hom]](a,a') \otimes \mathrm[\underline[Hom]](b,b') )$.
#! @Arguments s, list, r
...
#! @Returns a morphism ⥉ $\mathrm[Hom](1,a \otimes a^[\vee])$.
#! @Arguments a
...
#! @Returns a morphism ⥉ $\mathrm[Hom]((a^[\vee])^[\vee],a)$.
#! @Arguments a
