...
@InstallValueConst( LEFT_CLOSED_MONOIDAL_CATEGORIES_METHOD_NAME_RECORD, @rec(
...
LeftInternalHomToTensorProductAdjunctMorphismWithGivenTensorProduct = @rec(
  ...
  dual_preprocessor_func = ( cat, a, b, g, t ) -> @NTupleGAP( 5, Opposite( cat ), Opposite( b ), Opposite( a ), Opposite( g ), Opposite( t ) ),
  dual_arguments_reversed = false,
