...
#! @Returns a morphism ⥉ $\mathrm[Hom]( \mathrm[\underline[coHom]](a,b'), \mathrm[\underline[coHom]](a',b) )$
...
#! && an object $r == \mathrm[\underline[coHom]](a',b)$.
#! The output is the internal cohom morphism
#! $\mathrm[\underline[coHom]](\alpha,\beta): \mathrm[\underline[coHom]](a,b') \rightarrow \mathrm[\underline[coHom]](a',b)$.
#! @Returns a morphism ⥉ $\mathrm[Hom]( \mathrm[\underline[coHom]](a,b'), \mathrm[\underline[coHom]](a',b) )$
...
#! @Returns a morphism ⥉ $\mathrm[Hom]( a, \mathrm[\underline[coHom]](a,b) \otimes b )$.
#! @Arguments a, b
@DeclareOperation( "CoclosedEvaluationMorphism",
                  [ IsCapCategoryObject, IsCapCategoryObject ] );

#! @Description
#! The arguments are two objects $a,b$ && an object $r == \mathrm[\underline[coHom]](a,b) \otimes b$.
#! The output is the coclosed evaluation morphism $\mathrm[coclev]_[a,b]: a \rightarrow \mathrm[\underline[coHom]](a,b) \otimes b$, i.e.,
#! the unit of the cohom tensor adjunction.
#! @Returns a morphism ⥉ $\mathrm[Hom]( a, \mathrm[\underline[coHom]](a,b) \otimes b )$.
#! @Arguments a, b, r
...
#! @Returns a morphism ⥉ $\mathrm[Hom]( \mathrm[\underline[coHom]](a \otimes b, b), a )$.
#! @Arguments a, b
@DeclareOperation( "CoclosedCoevaluationMorphism",
                  [ IsCapCategoryObject, IsCapCategoryObject ] );

#! @Description
#! The arguments are two objects $a,b$ && an object $s == \mathrm[\underline[coHom](a \otimes b, b)]$.
#! The output is the coclosed coevaluation morphism $\mathrm[coclcoev]_[a,b]: \mathrm[\underline[coHom]](a \otimes b, b) \rightarrow a$, i.e.,
#! the unit of the cohom tensor adjunction.
#! @Returns a morphism ⥉ $\mathrm[Hom]( \mathrm[\underline[coHom]](a \otimes b, b), a )$.
#! @Arguments a, b, s
...
#! @Description
#! The arguments are two objects $c,b$ && a morphism $g: a \rightarrow c \otimes b$.
#! The output is a morphism $f: \mathrm[\underline[coHom]](a,b) \rightarrow c$
#! corresponding to $g$ under the cohom tensor adjunction.
#! @Returns a morphism ⥉ $\mathrm[Hom]( \mathrm[\underline[coHom]](a,b), c )$.
#! @Arguments c, b, g
@DeclareOperation( "TensorProductToInternalCoHomAdjunctionMap",
                  [ IsCapCategoryObject, IsCapCategoryObject, IsCapCategoryMorphism ] );

#! @Description
#! The arguments are two objects $c,b$, a morphism $g: a \rightarrow c \otimes b$ && an object $i == \mathrm[\underline[coHom](a,b)]$.
#! The output is a morphism $f: \mathrm[\underline[coHom]](a,b) \rightarrow c$
#! corresponding to $g$ under the cohom tensor adjunction.
#! @Returns a morphism ⥉ $\mathrm[Hom]( \mathrm[\underline[coHom]](a,b), c )$.
#! @Arguments c, b, g, i
...
#! @Description
#! The arguments are two objects $a,b$ && a morphism $f: \mathrm[\underline[coHom]](a,b) \rightarrow c$.
#! The output is a morphism $g: a \rightarrow c \otimes b$ corresponding to $f$ under the
#! cohom tensor adjunction.
#! @Returns a morphism ⥉ $\mathrm[Hom](a, c \otimes b)$.
#! @Arguments a, b, f
@DeclareOperation( "InternalCoHomToTensorProductAdjunctionMap",
                  [ IsCapCategoryObject, IsCapCategoryObject, IsCapCategoryMorphism ] );

#! @Description
#! The arguments are two objects $a,b$, a morphism $f: \mathrm[\underline[coHom]](a,b) \rightarrow c$ && an object $t == c \otimes b$.
#! The output is a morphism $g: a \rightarrow c \otimes b$ corresponding to $f$ under the
#! cohom tensor adjunction.
#! @Returns a morphism ⥉ $\mathrm[Hom](a, c \otimes b)$.
#! @Arguments a, b, f, t
...
#! @Returns a morphism ⥉ $\mathrm[Hom]( \mathrm[\underline[coHom]](a,c), \mathrm[\underline[coHom]](b,c) \otimes \mathrm[\underline[coHom]](a,b) )$.
#! @Arguments a,b,c
...
#! three objects $a,b,c$,
#! && an object $r == \mathrm[\underline[coHom]](a,b) \otimes \mathrm[\underline[coHom]](b,c)$.
#! The output is the precocomposition morphism
#! $\mathrm[MonoidalPreCoComposeMorphismWithGivenObjects]_[a,b,c]: \mathrm[\underline[coHom]](a,c) \rightarrow \mathrm[\underline[coHom]](b,c) \otimes \mathrm[\underline[coHom]](a,b)$.
#! @Returns a morphism ⥉ $\mathrm[Hom]( \mathrm[\underline[coHom]](a,c), \mathrm[\underline[coHom]](b,c) \otimes \mathrm[\underline[coHom]](a,b) )$.
#! @Arguments s,a,b,c,r
...
#! @Returns a morphism ⥉ $\mathrm[Hom]( \mathrm[\underline[coHom]](a,c), \mathrm[\underline[coHom]](a,b) \otimes \mathrm[\underline[coHom]](b,c) )$.
#! @Arguments a,b,c
...
#! an object $s == \mathrm[\underline[coHom]](a,c)$,
#! three objects $a,b,c$,
#! && an object $r == \mathrm[\underline[coHom]](b,c) \otimes \mathrm[\underline[coHom]](a,b)$.
#! The output is the postcocomposition morphism
#! $\mathrm[MonoidalPostCoComposeMorphismWithGivenObjects]_[a,b,c]: \mathrm[\underline[coHom]](a,c) \rightarrow \mathrm[\underline[coHom]](a,b) \otimes \mathrm[\underline[coHom]](b,c)$.
#! @Returns a morphism ⥉ $\mathrm[Hom]( \mathrm[\underline[coHom]](a,c), \mathrm[\underline[coHom]](a,b) \otimes \mathrm[\underline[coHom]](b,c) )$.
#! @Arguments s,a,b,c,r
...
#! @Returns a morphism ⥉ $\mathrm[Hom]( b_[\vee], a_[\vee] )$.
#! @Arguments alpha
...
#! @Returns a morphism ⥉ $\mathrm[Hom]( 1, a_[\vee] \otimes a )$.
#! @Arguments a
...
#! @Returns a morphism ⥉ $\mathrm[Hom]((a_[\vee])_[\vee], a)$.
#! @Arguments a
...
#! @Returns a morphism ⥉ $\mathrm[Hom]( \mathrm[\underline[coHom]](a \otimes a', b \otimes b'), \mathrm[\underline[coHom]](a,b) \otimes \mathrm[\underline[coHom]](a',b'))$.
#! @Arguments list
...
#! && two objects $s == \mathrm[\underline[coHom]](a \otimes a', b \otimes b')$ && $r == \mathrm[\underline[coHom]](a,b) \otimes \mathrm[\underline[coHom]](a',b')$.
#! The output is the natural morphism
#! $\mathrm[InternalCoHomTensorProductCompatibilityMorphismWithGivenObjects]_[a,a',b,b']: \mathrm[\underline[coHom]](a \otimes a', b \otimes b') \rightarrow \mathrm[\underline[coHom]](a,b) \otimes \mathrm[\underline[coHom]](a',b')$.
#! @Returns a morphism ⥉ $\mathrm[Hom]( \mathrm[\underline[coHom]](a \otimes a', b \otimes b'), \mathrm[\underline[coHom]](a,b) \otimes \mathrm[\underline[coHom]](a',b') )$.
#! @Arguments s, list, r
...
#! @Returns a morphism ⥉ $\mathrm[Hom]( (a \otimes b)_[\vee], a_[\vee] \otimes b_[\vee] )$.
#! @Arguments a,b
...
#! two objects $a,b$,
#! && an object $r == a_[\vee] \otimes b_[\vee]$.
#! The output is the natural morphism
...
#! @Returns a morphism ⥉ $\mathrm[Hom]( \mathrm[\underline[coHom]](a,b), b_[\vee] \otimes a )$.
#! @Arguments a,b
...
#! @Returns a morphism ⥉ $\mathrm[Hom]( \mathrm[\underline[coHom]](a,b), a \otimes b_[\vee] )$.
#! @Arguments s,a,b,r
...
#! @Returns a morphism ⥉ $\mathrm[Hom](a_[\vee], \mathrm[\underline[coHom]](1,a))$.
#! @Arguments a
...
#! @Returns a morphism ⥉ $\mathrm[Hom](\mathrm[\underline[coHom]](1,a), a_[\vee])$.
#! @Arguments a
...
#! @Returns a morphism ⥉ $\mathrm[Hom]( \mathrm[\underline[coHom]](a,b), 1 )$.
#! @Arguments alpha
...
#! @Description
#! The arguments are two objects $a,b$,
#! && a morphism $\alpha: \mathrm[\underline[coHom]](a,b) \rightarrow 1$.
...
#! @Returns a morphism ⥉ $\mathrm[Hom](a, \mathrm[\underline[coHom]](a,1))$.
#! @Arguments a
...
#! @Description
#! The argument is an object $a$,
#! && an object $r == \mathrm[\underline[coHom]](a,1)$.
#! The output is the natural isomorphism $a \rightarrow \mathrm[\underline[coHom]](a,1)$.
#! @Returns a morphism ⥉ $\mathrm[Hom](a, \mathrm[\underline[coHom]](a,1))$.
#! @Arguments a,r
...
#! @Returns a morphism ⥉ $\mathrm[Hom](\mathrm[\underline[coHom]](a,1), a)$.
#! @Arguments a
...
#! @Description
#! The argument is an object $a$,
#! && an object $s == \mathrm[\underline[coHom]](a,1)$.
#! The output is the natural isomorphism $\mathrm[\underline[coHom]](a,1) \rightarrow a$.
#! @Returns a morphism ⥉ $\mathrm[Hom](\mathrm[\underline[coHom]](a,1), a)$.
#! @Arguments a,s
