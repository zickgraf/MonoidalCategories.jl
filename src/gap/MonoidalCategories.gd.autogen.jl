...
#! @Returns a morphism ⥉ $\mathrm[Hom](a \otimes b, a' \otimes b')$
...
#! @Returns a morphism ⥉ $\mathrm[Hom]( a \otimes (b \otimes c), (a \otimes b) \otimes c )$.
#! @Arguments a, b, c
...
#! three objects $a,b,c$,
#! && an object $r == (a \otimes b) \otimes c$.
#! The output is the associator $\alpha_[a,(b,c)]: a \otimes (b \otimes c) \rightarrow (a \otimes b) \otimes c$.
#! @Returns a morphism ⥉ $\mathrm[Hom]( a \otimes (b \otimes c), (a \otimes b) \otimes c )$.
#! @Arguments s, a, b, c, r
...
#! The arguments are three objects $a,b,c$.
#! The output is the associator $\alpha_[(a,b),c]: (a \otimes b) \otimes c \rightarrow a \otimes (b \otimes c)$.
#! @Returns a morphism ⥉ $\mathrm[Hom]( (a \otimes b) \otimes c \rightarrow a \otimes (b \otimes c) )$.
#! @Arguments a, b, c
...
#! @Returns a morphism ⥉ $\mathrm[Hom](1 \otimes a, a)$
#! @Arguments a
@DeclareAttribute( "LeftUnitor",
                  IsCapCategoryObject );

#! @Description
#! The arguments are an object $a$ && an object $s == 1 \otimes a$.
#! The output is the left unitor $\lambda_a: 1 \otimes a \rightarrow a$.
#! @Returns a morphism ⥉ $\mathrm[Hom](1 \otimes a, a)$
#! @Arguments a, s
...
#! @Returns a morphism ⥉ $\mathrm[Hom](a, 1 \otimes a)$
#! @Arguments a
@DeclareAttribute( "LeftUnitorInverse",
                  IsCapCategoryObject );

#! @Description
#! The argument is an object $a$ && an object $r == 1 \otimes a$.
#! The output is the inverse of the left unitor $\lambda_a^[-1]: a \rightarrow 1 \otimes a$.
#! @Returns a morphism ⥉ $\mathrm[Hom](a, 1 \otimes a)$
#! @Arguments a, r
...
#! @Returns a morphism ⥉ $\mathrm[Hom](a \otimes 1, a)$
#! @Arguments a
@DeclareAttribute( "RightUnitor",
                  IsCapCategoryObject );

#! @Description
#! The arguments are an object $a$ && an object $s == a \otimes 1$.
#! The output is the right unitor $\rho_a: a \otimes 1 \rightarrow a$.
#! @Returns a morphism ⥉ $\mathrm[Hom](a \otimes 1, a)$
#! @Arguments a, s
...
#! @Returns a morphism ⥉ $\mathrm[Hom](a, a \otimes 1)$
#! @Arguments a
...
#! @Description
#! The arguments are an object $a$ && an object $r == a \otimes 1$.
#! The output is the inverse of the right unitor $\rho_a^[-1]: a \rightarrow a \otimes 1$.
#! @Returns a morphism ⥉ $\mathrm[Hom](a, a \otimes 1)$
#! @Arguments a, r
