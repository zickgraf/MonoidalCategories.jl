...
end; CategoryFilter = cat -> HasIsLeftClosedMonoidalCategory( cat ) && IsLeftClosedMonoidalCategory( cat ) && HasIsStrictMonoidalCategory( cat ) && IsStrictMonoidalCategory( cat ) );
