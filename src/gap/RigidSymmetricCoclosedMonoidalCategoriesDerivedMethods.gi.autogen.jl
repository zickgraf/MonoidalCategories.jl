...
end; CategoryFilter = cat -> HasIsRigidSymmetricCoclosedMonoidalCategory( cat ) && IsRigidSymmetricCoclosedMonoidalCategory( cat ) && HasIsStrictMonoidalCategory( cat ) && IsStrictMonoidalCategory( cat ) );
