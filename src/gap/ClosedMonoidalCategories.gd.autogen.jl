...
#! @Returns a morphism ⥉ $\mathrm[Hom]( \mathrm[\underline[Hom]](a',b), \mathrm[\underline[Hom]](a,b') )$
...
#! && an object $r == \mathrm[\underline[Hom]](a,b')$.
#! The output is the internal hom morphism
#! $\mathrm[\underline[Hom]](\alpha,\beta): \mathrm[\underline[Hom]](a',b) \rightarrow \mathrm[\underline[Hom]](a,b')$.
#! @Returns a morphism ⥉ $\mathrm[Hom]( \mathrm[\underline[Hom]](a',b), \mathrm[\underline[Hom]](a,b') )$
...
#! @Returns a morphism ⥉ $\mathrm[Hom]( \mathrm[\underline[Hom]](a,b) \otimes a, b )$.
#! @Arguments a, b
...
#! @Description
#! The arguments are two objects $a,b$ && an object $s == \mathrm[\underline[Hom]](a,b) \otimes a$.
#! The output is the evaluation morphism $\mathrm[ev]_[a,b]: \mathrm[\underline[Hom]](a,b) \otimes a \rightarrow b$, i.e.,
#! the counit of the tensor hom adjunction.
#! @Returns a morphism ⥉ $\mathrm[Hom]( \mathrm[\underline[Hom]](a,b) \otimes a, b )$.
#! @Arguments a, b, s
...
#! @Returns a morphism ⥉ $\mathrm[Hom]( a, \mathrm[\underline[Hom]](b, a \otimes b) )$.
#! @Arguments a, b
...
#! @Description
#! The arguments are two objects $a,b$ && an object $r == \mathrm[\underline[Hom]](b, a \otimes b)$.
#! The output is the coevaluation morphism $\mathrm[coev]_[a,b]: a \rightarrow \mathrm[\underline[Hom]](b, a \otimes b)$, i.e.,
#! the unit of the tensor hom adjunction.
#! @Returns a morphism ⥉ $\mathrm[Hom]( a, \mathrm[\underline[Hom]](b, a \otimes b) )$.
#! @Arguments a, b, r
...
#! @Description
#! The arguments are two objects $a,b$ && a morphism $f: a \otimes b \rightarrow c$.
#! The output is a morphism $g: a \rightarrow \mathrm[\underline[Hom]](b,c)$
#! corresponding to $f$ under the tensor hom adjunction.
#! @Returns a morphism ⥉ $\mathrm[Hom]( a, \mathrm[\underline[Hom]](b,c) )$.
#! @Arguments a, b, f
@DeclareOperation( "TensorProductToInternalHomAdjunctionMap",
                  [ IsCapCategoryObject, IsCapCategoryObject, IsCapCategoryMorphism ] );

#! @Description
#! The arguments are two objects $a,b$, a morphism $f: a \otimes b \rightarrow c$ && an object $i == \mathrm[\underline[Hom]](b,c)$.
#! The output is a morphism $g: a \rightarrow \mathrm[\underline[Hom]](b,c)$
#! corresponding to $f$ under the tensor hom adjunction.
#! @Returns a morphism ⥉ $\mathrm[Hom]( a, \mathrm[\underline[Hom]](b,c) )$.
#! @Arguments a, b, f, i
...
#! @Description
#! The arguments are two objects $b,c$ && a morphism $g: a \rightarrow \mathrm[\underline[Hom]](b,c)$.
#! The output is a morphism $f: a \otimes b \rightarrow c$ corresponding to $g$ under the
#! tensor hom adjunction.
#! @Returns a morphism ⥉ $\mathrm[Hom](a \otimes b, c)$.
#! @Arguments b, c, g
@DeclareOperation( "InternalHomToTensorProductAdjunctionMap",
                  [ IsCapCategoryObject, IsCapCategoryObject, IsCapCategoryMorphism ] );

#! @Description
#! The arguments are two objects $b,c$, a morphism $g: a \rightarrow \mathrm[\underline[Hom]](b,c)$ && an object $t == a \otimes b$.
#! The output is a morphism $f: a \otimes b \rightarrow c$ corresponding to $g$ under the
#! tensor hom adjunction.
#! @Returns a morphism ⥉ $\mathrm[Hom](a \otimes b, c)$.
#! @Arguments b, c, g, t
...
#! @Returns a morphism ⥉ $\mathrm[Hom]( \mathrm[\underline[Hom]](a,b) \otimes \mathrm[\underline[Hom]](b,c), \mathrm[\underline[Hom]](a,c) )$.
#! @Arguments a,b,c
...
#! three objects $a,b,c$,
#! && an object $r == \mathrm[\underline[Hom]](a,c)$.
#! The output is the precomposition morphism
#! $\mathrm[MonoidalPreComposeMorphismWithGivenObjects]_[a,b,c]: \mathrm[\underline[Hom]](a,b) \otimes \mathrm[\underline[Hom]](b,c) \rightarrow \mathrm[\underline[Hom]](a,c)$.
#! @Returns a morphism ⥉ $\mathrm[Hom]( \mathrm[\underline[Hom]](a,b) \otimes \mathrm[\underline[Hom]](b,c), \mathrm[\underline[Hom]](a,c) )$.
#! @Arguments s,a,b,c,r
...
#! @Returns a morphism ⥉ $\mathrm[Hom]( \mathrm[\underline[Hom]](b,c) \otimes \mathrm[\underline[Hom]](a,b), \mathrm[\underline[Hom]](a,c) )$.
#! @Arguments a,b,c
...
#! @Returns a morphism ⥉ $\mathrm[Hom]( a^[\vee] \otimes a, 1 )$.
#! @Arguments a
...
#! @Returns a morphism ⥉ $\mathrm[Hom]( \mathrm[\underline[Hom]](a,a') \otimes \mathrm[\underline[Hom]](b,b'), \mathrm[\underline[Hom]](a \otimes b,a' \otimes b'))$.
#! @Arguments list
...
#! && two objects $s == \mathrm[\underline[Hom]](a,a') \otimes \mathrm[\underline[Hom]](b,b')$ && $r == \mathrm[\underline[Hom]](a \otimes b,a' \otimes b')$.
#! The output is the natural morphism
#! $\mathrm[TensorProductInternalHomCompatibilityMorphismWithGivenObjects]_[a,a',b,b']: \mathrm[\underline[Hom]](a,a') \otimes \mathrm[\underline[Hom]](b,b') \rightarrow \mathrm[\underline[Hom]](a \otimes b,a' \otimes b')$.
#! @Returns a morphism ⥉ $\mathrm[Hom]( \mathrm[\underline[Hom]](a,a') \otimes \mathrm[\underline[Hom]](b,b'), \mathrm[\underline[Hom]](a \otimes b,a' \otimes b'))$.
#! @Arguments s, list, r
...
#! @Returns a morphism ⥉ $\mathrm[Hom]( a^[\vee] \otimes b^[\vee], (a \otimes b)^[\vee] )$.
#! @Arguments a,b
...
#! @Returns a morphism ⥉ $\mathrm[Hom]( a^[\vee] \otimes b, \mathrm[\underline[Hom]](a,b) )$.
#! @Arguments a,b
...
#! @Returns a morphism ⥉ $\mathrm[Hom](a^[\vee], \mathrm[\underline[Hom]](a,1))$.
#! @Arguments a
...
#! @Returns a morphism ⥉ $\mathrm[Hom](\mathrm[\underline[Hom]](a,1), a^[\vee])$.
#! @Arguments a
...
#! && a morphism $\alpha: t \otimes a \rightarrow 1$.
...
#! @Returns a morphism ⥉ $\mathrm[Hom]( 1, \mathrm[\underline[Hom]](a,b) )$.
#! @Arguments alpha
...
#! @Description
#! The arguments are two objects $a,b$,
#! && a morphism $\alpha: 1 \rightarrow \mathrm[\underline[Hom]](a,b)$.
...
#! @Returns a morphism ⥉ $\mathrm[Hom](a, \mathrm[\underline[Hom]](1,a))$.
#! @Arguments a
...
#! @Description
#! The argument is an object $a$,
#! && an object $r == \mathrm[\underline[Hom]](1,a)$.
#! The output is the natural isomorphism $a \rightarrow \mathrm[\underline[Hom]](1,a)$.
#! @Returns a morphism ⥉ $\mathrm[Hom](a, \mathrm[\underline[Hom]](1,a))$.
#! @Arguments a,r
...
#! @Returns a morphism ⥉ $\mathrm[Hom](\mathrm[\underline[Hom]](1,a),a)$.
#! @Arguments a
...
#! @Description
#! The argument is an object $a$,
#! && an object $s == \mathrm[\underline[Hom]](1,a)$.
#! The output is the natural isomorphism $\mathrm[\underline[Hom]](1,a) \rightarrow a$.
#! @Returns a morphism ⥉ $\mathrm[Hom](\mathrm[\underline[Hom]](1,a),a)$.
#! @Arguments a,s
