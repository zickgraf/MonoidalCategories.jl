...
end; CategoryFilter = cat -> HasIsLeftCoclosedMonoidalCategory( cat ) && IsLeftCoclosedMonoidalCategory( cat ) && HasIsStrictMonoidalCategory( cat ) && IsStrictMonoidalCategory( cat ) );
